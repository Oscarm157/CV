...
const content = {
  ...
  generativa: {
    es: {
      eyebrow: "Perfil",
      headline: "Marketing Estratégico + IA Generativa · Contenido Audiovisual · Datos",
      p1: "Mercadólogo con +10 años en estrategia digital y marketing, con base creativa de 7 años dirigiendo campañas audiovisuales y branding en Kraken. Uso la IA generativa como herramienta del marketing, no como fin: para producir contenido y para decidir con datos.",
      p2: "En lo audiovisual genero imagen con Nano Banana Pro (2K/4K) y video image-to-video con Kling, orquestados en Replicate y en flujos nodales de Weavy.ai / Figma Wave. En datos construyo análisis y predicción: califico leads por score, cruzo datos de mercado para estimar oportunidad y riesgo (inmobiq) y proyecto métricas en dashboards. Itero prompts, valido resultados y automatizo el flujo. En Atisa Group capacito equipos en la adopción de IA.",
      tags: [
        "Marketing Estratégico", "IA Generativa", "Contenido Audiovisual", "Imagen con IA", "Video image-to-video",
        "Datos & Predicción", "Lead Scoring", "Inteligencia de Mercado", "Prompt Engineering", "Automatización",
        "Nano Banana Pro", "Kling", "Weavy.ai", "Replicate",
      ],
    },
    en: {
      eyebrow: "About",
      headline: "Strategic Marketing + Generative AI · Audiovisual Content · Data",
      p1: "Marketer with 10+ years in digital strategy and marketing, with a creative base of 7 years leading video campaigns and branding at Kraken. I use generative AI as a marketing tool, not an end in itself: to produce content and to decide with data.",
      p2: "On the audiovisual side I generate images with Nano Banana Pro (2K/4K) and image-to-video with Kling, orchestrated in Replicate and node-based flows on Weavy.ai / Figma Wave. On data I build analysis and prediction: I score leads, cross market data to estimate opportunity and risk (inmobiq) and project metrics in dashboards. I iterate prompts, validate results and automate the flow. At Atisa Group I train teams on AI adoption.",
      tags: [
        "Strategic Marketing", "Generative AI", "Audiovisual Content", "AI Image", "Image-to-video",
        "Data & Prediction", "Lead Scoring", "Market Intelligence", "Prompt Engineering", "Automation",
        "Nano Banana Pro", "Kling", "Weavy.ai", "Replicate",
      ],
    },
  },
