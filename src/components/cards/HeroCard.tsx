...
export default function HeroCard() {
  ...
  return (
    ...
    >
      {/* LEFT — text */}
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-8 md:px-12 py-8 md:py-10 relative overflow-hidden">
        ...
        <h1
          ...
          style={{ fontSize: "clamp(1.5rem, 7vw, 5rem)", letterSpacing: "-0.05em" }}
        >
